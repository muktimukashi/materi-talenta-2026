...
async def menu_awal(layar, jam, font_besar, font, font_kecil):
    nama = ""
...
async def jalankan_game(layar, jam, nama, font, font_kecil):
...
async def main():
    ...
    while aplikasi_aktif:
        ...
        while bermain:
            hasil, player = await jalankan_game(
                layar,
                jam,
                nama,
                font,
